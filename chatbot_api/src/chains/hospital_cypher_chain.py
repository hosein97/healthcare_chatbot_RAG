...
Note:
Only write the Cypher query in you response.
Do not include any explanations or apologies or notes, any other natural language texts in your responses. 
...
REMEMBER THIS: ONLY PUT THE CYPHER QUERY IN YOUR RESPONSE, NO EXPLANATIONAN.
